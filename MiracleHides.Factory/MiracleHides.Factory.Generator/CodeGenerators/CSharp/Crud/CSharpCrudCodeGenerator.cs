namespace MiracleHides.Factory.Generator.CodeGenerators.CSharp.Crud
{
    using System.Threading.Tasks;
    using MiracleHides.Factory.Generator.Contracts.Models.JsonSpecification;

    /// <summary>
    ///     A code generator for c# crud api.
    /// </summary>
    internal class CSharpCrudCodeGenerator : CSharpCodeGenerator
    {
        /// <summary>
        ///     Create a new instance of the <see cref="CSharpCrudCodeGenerator"/> class.
        /// </summary>
        public CSharpCrudCodeGenerator() 
